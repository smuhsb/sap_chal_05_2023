CLASS zcl_smuhsb_w4 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_smuhsb_w4 IMPLEMENTATION.
  METHOD constructor.
    engine = NEW #( ).
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    out->write( interprete( 'MAP' )->get(  ) ).
    out->write( interprete( 'WEST'  )->get(  ) ).
    out->write( interprete( 'SOUTH'  )->get(  ) ).
    out->write( interprete( 'LOOK'  )->get(  ) ).
    out->write( interprete( 'TAKE BOX'  )->get(  ) ).
    out->write( interprete( 'OPEN BOX'  )->get(  ) ).
*    out->write( interprete( 'DROP KNIFE'  )->get(  ) ).
*    out->write( interprete( 'DROP BOX'  )->get(  ) ).
    out->write( interprete( 'INV'  )->get(  ) ).
    out->write( interprete( 'NORTH'  )->get(  ) ).
    out->write( interprete( 'EAST'  )->get(  ) ).
    out->write( interprete( 'ASK Bill'  )->get(  ) ).
